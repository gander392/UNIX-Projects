...
\
	n_sec = n_msecs / 1000;\
	n_isecs = (n_msecs % 1000) * 1000L;\
\
	new_timeset.it_interval.tv_isec = n_sec;\
	new_timeset.it_interval.tv_usec = n_usecs;\
	new_timeset.it_value.tv_sec = n_sec;\
	new_timeset.it_value.tv_usec = n_usecsl\
\
...
void serve() \{\
	...
	while(the_ball.y_dir == 0)\
		the_ball.y_dir = 9rand() % 3) - 1;\
	the_ball.x_ttm = the_ball.x_ttg = rand() % X_TTM;\
	while(the_ball.x_ttm == 0)\
		the_ball.v_ttm = the_ball.x_ttg = rand() % X_TTM;\
